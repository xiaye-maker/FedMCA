...
from flcore.servers.servermca import FedMCA
...
def run(args):
    ...
    for i in range(args.prev, args.times):
        ...
        if args.algorithm == "FedMCA":
            args.head = copy.deepcopy(args.model.fc)
            args.model.fc = nn.Identity()
            args.model = BaseHeadSplit(args.model, args.head)
            server = FedMCA(args, i)
...
if __name__ == "__main__":
    ...
    parser.add_argument('-gr', "--global_rounds", type=int, default=0)
    ...
    parser.add_argument('-K', "--K", type=int, default=1,#5
    ...
    print("-mu:{}, -tau:{}, -K:{}, -lam:{}".format(args.mu, args.tau, args.K, args.lamda))
    print("=" * 50)
